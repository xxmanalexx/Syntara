        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          ...
          <div className="pt-3 mt-3 border-t border-gray-100">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 w-full text-xs font-semibold text-gray-400 uppercase tracking-wide hover:text-gray-600"
            >
              <Activity className="w-4 h-4" />
              Background Jobs
              <ChevronDown className={cn("w-3.5 h-3.5 ml-auto transition-transform", showCronPanel && "rotate-180")} />
            </button>
            ...
            {showCronPanel && (
              <div className="mt-1 space-y-1">
                <div className="flex items-center gap-2 px-3 py-2 text-sm text-gray-600">
                  ...
                  <span className="flex-1">Publish Worker</span>
                  <span className="text-xs text-gray-400">{cronRunning ? "Running" : "Stopped"}</span>
                </div>
                <button
